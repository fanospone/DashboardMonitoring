<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="UploadTargetRepoAR.aspx.cs" Inherits="UploaderZipcode.UploadTargetRepoAR" %>


<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div class="block-header">
        <h2>UPLOAD TARGET REPO AR</h2>
    </div>
            ...
            <form runat="server">
                <div class="card">
                    <div class="body">
                        ...
                        <a id="tmpDownload" href="TemplateExcel/Template_Upload_Target_Repo_AR.xls" target="_blank" class="btn bg-orange btn-lg waves-effect right">Download Template</a>
                        <div></div>

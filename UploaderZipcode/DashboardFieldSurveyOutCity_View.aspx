<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DashboardFieldSurveyOutCity_View.aspx.cs" Inherits="UploaderZipcode.DashboardFieldSurveyOutCity_View" %>
    ...
    <table id="tb1" style="height: 13.5vh" class="font1">
        <tbody>
            <tr class="grey">
                ...
                <th rowspan="1" colspan="1" class="size8" style="background-color: #D8D8D8">TOTAL TITIK IN OUTCITY</th>
            ...
            <tr class="font2">
                <th rowspan="1" colspan="1" style="background-color: #F2F2F2"><span id="SumInOutcty" runat="server"></span></th>
                ...
                <asp:TemplateField>
                    ...
                    <HeaderTemplate>
                        <tr style="height: 3vh" class="font1">
                            ...
                            <th rowspan="3" colspan="1" style="width: 6%">TITIK IN [OUTCITY]</th>
                            <th rowspan="3" colspan="1" style="width: 6%">NOT FIELD SURVEY</th>
                            <th rowspan="3" colspan="1" style="width: 6%">NOT SAME DAY</th>

<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="UserSetting2.aspx.cs" Inherits="UploaderZipcode.UserSetting2" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        setTimeout("location.href = 'UserSetting.aspx'", 5000); // milliseconds, so 10 seconds = 10000ms
    </script>
</asp:Content>

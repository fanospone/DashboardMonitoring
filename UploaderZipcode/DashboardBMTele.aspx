<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DashboardBMTele.aspx.cs" Inherits="UploaderZipcode.DashboardBMTele" %>
...
<body class="color5">
    <table id="tb1" style="height: 16vh" class="font1">
        <tbody>
           <%--  <tr style="height: 4vh">
                <th rowspan="1" colspan="19" style="background-color: #BFBFBF">TOYOTA ASTRA FINANCE - <span id="office" runat="server"></span></th>
            </tr>--%>
            <tr class="grey">
    ...
    <form runat="server">
        <div id="form1" style="height: 80vh; padding: 0px" class="col-sm-9">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DashboardFieldSurveyInCity.aspx.cs" Inherits="UploaderZipcode.DashboardFieldSurveyInCity" %>
...
<body class="color2">
   ...
   <%-- <table id="tb3" style="height: 13.5vh;" class="font1">
        <tbody>
            <tr class="font2">
            </tr>
        </tbody>

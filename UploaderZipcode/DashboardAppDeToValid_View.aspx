<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DashboardAppDeToValid_View.aspx.cs" Inherits="UploaderZipcode.DashboardAppDeToValid_View" %>
...
<body>
    ...
    <form id="form1" runat="server" style="min-height: 80vh; max-height: 80vh; width: 99.9%">
                ...
                <asp:TemplateField>
                    ...
                    <HeaderTemplate>
                        ...
                        <tr style="height: 5vh" class="fcwhite">
                            ...
                            <th rowspan="3" colspan="1" class="size5 color4">CDE</th>
                            <th rowspan="1" colspan="7" class="color1">CAPACITY DECISION PROCESS</th>
                        ...
                        <tr style="height: 16vh" class="fcwhite">
                            ...
                            <th rowspan="1" colspan="1" class="size5 color5">CREDIT ANALYST</th>
                           ...
                           <%-- <th rowspan="1" colspan="1" class="size5 color2">SH</th>
                            ...
                            <th rowspan="1" colspan="1" class="size5 color5">CHA</th>
                    ...
                    <ItemTemplate>
                      ...
                      <%--  <td style="text-align: center;" class="color4"><%# Eval("OP_BH") %></td>
                        <td style="text-align: center;" class="color4"><%# Eval("OP_SAH") %></td>--%>
...
<%--<script type="text/javascript">
    ...
    setTimeout("location.href = 'DashboardAppDeToValid.aspx?SeqNo=" + seqNo + "'", 5000); // milliseconds, so 10 seconds = 10000ms
</script>--%>
